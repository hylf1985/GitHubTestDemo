...
namespace KEE.IODataGridView
{
    ...
    public static class DataGridViewStyle
    {
        ...
        /// 普通的样式
        /// </summary>        
        public static void DgvStyle1(this DataGridView dgv)
        {
            //奇数行的背景色
        ...
        public static void DgvStyle2(this DataGridView dgv)
        {
            //奇数行的背景色
        ...
        /// 华丽的样式
        /// </summary>
        public static void DgvStyle3(this DataGridView dgv)
        {
            //未显示数据时的背景色
